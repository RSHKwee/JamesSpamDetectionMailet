...
public class MultiSourceMain {
  private static final Logger LOGGER = LoggerFactory.getLogger(MultiSourceMain.class);
  private static int teller = 0;

  public static void main(String[] args) throws IOException {
    MultiSourceSpamDetectorMailet mailet = new MultiSourceSpamDetectorMailet();
    ...
    try {
      ...
      mimeMessages.forEach(msg -> {
        ...
        try {
          mailet.service(mail);
          String[] probabilityHeader = mail.getMessage().getHeader("X-Spam-Status");
          LOGGER.info(teller + ": Spam Status: " + probabilityHeader[0]);
          teller++;
